...
<head>
    ...
    <link rel="shortcut icon" href="https://livebuzz-production.s3.eu-west-1.amazonaws.com/ocean-media/campaign/0aad5e6e-435b-11ea-a207-000000000000/favicon.png">
    <link href="{{ mix("css/app.css") }}" rel="stylesheet">
    <link rel="stylesheet" href="https://use.typekit.net/msk6xoz.css">
    @stack('js-head')
